...
<html lang="fr">';?>
    ...
    echo '
        <link rel="preload" fetchpriority="high" as="image" href="img/train_avant_pour_supercar_2.webp" type="image/webp">
        <link rel="preload" fetchpriority="high" as="image" href="img/train_avant_pour_supercar_3.webp" type="image/webp">    
    </head>
    <body>';?>
                ...
                <div class="div-section-div">
                    <article class="div-section-div-article">
                        ...
                        <figure class="div-section-div-article-figure">
                            <img class="div-section-div-article-figure-img" fetchpriority="low" src="img/train_avant_pour_supercar_2.webp" alt="Rendu en image" width="800" height="600" onclick="enlargeReduceImg()" id="img">
                            <img class="div-section-div-article-figure-noDisplay_img" fetchpriority="low" src="img/train_avant_pour_supercar_3.webp" alt="Rendu en image" width="1024" height="768" onclick="enlargeReduceImg()" id="enlargeImg">
                        </figure>
                    </article>
