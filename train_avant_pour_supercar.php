                ...
                <div class="div-section-div">
                    <article class="div-section-div-article">
                        ...
                        <figure class="div-section-div-article-figure">
                            <img class="div-section-div-article-figure-img" fetchpriority="high" src="img/train_avant_pour_supercar_2.webp" alt="Rendu en image" width="800" height="600" srcset="img/train_avant_pour_supercar_2.webp 270w, img/train_avant_pour_supercar_2.webp 800w" sizes="100vw" onclick="enlargeReduceImg()" id="img">
                            <img class="div-section-div-article-figure-noDisplay_img" fetchpriority="high" src="img/train_avant_pour_supercar_3.webp" alt="Rendu en image" width="1024" height="768" srcset="img/train_avant_pour_supercar_2.webp 1024w" onclick="enlargeReduceImg()" sizes="100vw" id="enlargeImg">
                        </figure>
                    </article>
