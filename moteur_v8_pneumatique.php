                ...
                <div class="div-section-div">
                    <article class="div-section-div-article">
                        ...
                        <figure class="div-section-div-article-figure">
                            <img class="div-section-div-article-figure-img" fetchpriority="high" src="img/v8pneumatique_mediumComp.webp" alt="Rendu en image" width="300" height="300" onclick="enlargeReduceImg()" id="img">
                            <img class="div-section-div-article-figure-noDisplay_img" fetchpriority="high" src="img/v8pneumatique_largeComp.webp" alt="Rendu en image" width="1024" height="1024" onclick="enlargeReduceImg()" id="enlargeImg">
                        </figure>
                    </article>
