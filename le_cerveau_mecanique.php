                ...
                <div class="div-section-div">
                    ...
                    <aside class="div-section-div-aside">
                        ...
                        <ul class="div-section-div-aside-ul">
                            <li class="div-section-aside-ul-li">Il s\'agit de montrer ma vision d\'une architecteur de cerveau mécanique.</li>
                            <li class="div-section-aside-ul-li">En vue d\'une approche mecanique de la mémoire.</li>
                            <li class="div-section-aside-ul-li">Le plus important c\'est que pour moi le cerveau mecanique est gérer par un coeur, un coeur qui a notion du bien et du mal et choisi toujours le bien pour prendre une décision.</li>
                            ...
                            <li class="div-section-aside-ul-li">Les zones mémorielles sont protégé les unes des autres par des frontières mais il y a des points de connexions entre celles ci et le réseaux neuronaux. Les comparaisons ce font entre la partie droite (D) et gauche (G) par symétrie dans le réseau de neuronnes.</li>
                            <li class="div-section-aside-ul-li">Les neuronnes sont fixe dans l\'espace ils ont tous une place spécifique est des rôles particuliers pour exécuter des tâches spécifiques.</li>
                            <li class="div-section-aside-ul-li">La machine est cadencé par une certaine fréquence et par une horloge électronique.</li>
