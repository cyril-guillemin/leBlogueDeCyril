                ...
                <div class="div-section-div">
                    ...
                    <aside class="div-section-div-aside">
                        ...
                        <ul class="div-section-div-aside-ul">
                            <li class="div-section-aside-ul-li">V de 90° donc idéal pour couplage avec un ou 3 autre v (moteur en mode 2v ou 4v).</li>
                            ...
                            <li class="div-section-aside-ul-li">
                                Compatible en mode 2v au <a class="div-section-div-aside-ul-li-a" href="train_arriere_pour_supercar.php">train arrière pour supercar</a> qui est équipé d\'un différentiel à double plateau conique.</a>
                            </li>
