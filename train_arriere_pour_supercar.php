                    ...
                    <aside class="div-section-div-aside">
                        ...
                        <ul class="div-section-div-aside-ul">
                            ...
                            <li class="div-section-aside-ul-li">
                                Idéale pour y intégrer un moteur en mode 2v (<a class="div-section-div-aside-ul-li-a" href="moteur_v8_pneumatique_fictif_pour_son_mécanique.php">voir moteur V8 pneumatique fictif pour son mécanique</a>).</li>
